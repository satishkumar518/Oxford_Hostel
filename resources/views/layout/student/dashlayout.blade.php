            ...
            <div class="container-fluid">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="../{{Auth::guard('student')->user()->image}}" alt="user-image" class="rounded-circle" />
                            <span class="pro-user-name ml-1">
                                {{Auth::guard('student')->user()->name}} <i class="mdi mdi-chevron-down"></i>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown">
                            ...
                            <!-- item-->
                            <a href="{{route('studentProfile')}}" class="dropdown-item notify-item">
                                <i class="fa fa-user-circle"></i>
                                <span>Profile</span>
                            </a>

                            <!-- item-->
                            <a href="{{route('student_change_password')}}" class="dropdown-item notify-item">
                            ...
                            <!-- item-->
                            <a href="{{route('Student_Logout')}}" class="dropdown-item notify-item">
                ...
                <div class="logo-box">
                    <a href="#" class="logo logo-light text-center">
                        <span class="logo-sm">
                            <span class="logo-lg-text-light"><span class="text-warning">Student</span></span>
                        </span>
                        <span class="logo-lg">
                            <span class="logo-lg-text-light"><span class="text-warning">Student</span></span>
                        </span>
